...
class GUIAgent(Agent):
    ...
    def __init__(self, jid, password, local_resource_agent_jid, machine_jid):
    ...
    class SendBehaviour(OneShotBehaviour):
        ...
        async def run(self):
            ...
            if service == '1':
                ...
                msg.to = str(self.agent.machine_jid)
                msg.body = "COLLECTION:" + position

            await self.send(msg)
            print("[" + str(self.agent.jid) + "] [GUIAgent, SendBehaviour] service request to " + msg.to + ": " + msg.body)
    ...
    async def acl_post_controller(self, request):
        ...
        print("[" + str(self.jid) + "] [GUIAgent, acl_post_controller] HTTP message from HTML form: " + str(data_str))
